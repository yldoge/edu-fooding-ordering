package com.yldog.order.service.application.rest;
...
import com.yldog.order.service.domain.ports.input.service.OrderApplicationService;
...
public class OrderController {
    ...
    public ResponseEntity<CreateOrderResponse> createOrder(@RequestBody CreateOrderCommand createOrderCommand) {
        log.info("Creating order ofr customer: {} at restaurant: {}",
