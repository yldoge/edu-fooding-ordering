...
public class OrderMessagingDataMapper {
    ...
    orderPaidEventToRestaurantApprovalRequestAvroModel(OrderPaidEvent orderPaidEvent) {
        ...
        return RestaurantApprovalRequestAvroModel.newBuilder()
                ...
                .setProducts(order.getItems().stream().map(orderItemDomain ->
                        Product.newBuilder()
                                .setId(orderItemDomain.getProduct().getId().getValue().toString())
                                .setQuantity(orderItemDomain.getQuantity())
    ...
    approvalResopnseAvroModelToApprovalResopnse(RestaurantApprovalResponseAvroModel restaurantApprovalResponseAvroModel) {
